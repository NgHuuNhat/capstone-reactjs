...
export default function Header() {
  return (
    <header className="p-4 bg-coolGray-100 text-coolGray-800 z-10 bg-opacity-40 bg-black text-white fixed w-full">
      <div className="container flex justify-between h-16 mx-auto">
        ...
        > */}
          <NavLink to="/">
            <div>
              <img
                src="360_F_92950119_QlemH9AlK92LCWcbcUj7pCfCi1FbJcmZ.jpg"
                width={60}
                alt="logo"
              />
              <br />
